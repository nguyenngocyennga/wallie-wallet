...
const app = new Hono()
    .get(
        ...
        async (c) => {
            ...
            const data = await db
                ...
                .from(transactions)
                .innerJoin(accounts, eq(transactions.accountId, accounts.id)) // inner join to include only transactions with accounts
                .leftJoin(categories, eq(transactions.categoryId, categories.id)) // left join to include transactions without categories
                .where(
                    and(
    ...
    .post(
        ...
        async (c) => {
            ...
            // create a subquery to get the transactions to delete
